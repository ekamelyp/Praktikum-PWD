<div class="container">
    <div class="row">
                            ...
                            foreach ($cartItems as $item) { ?>
                                <tr>
                                    <td>
                                        ...
                                        <img class="" width="100" src="<?php echo base_url() . 'public/uploads/dishesh/thumb/' . $image; ?>">
                                    </td>
        ...
        <div class="col-md-4">
            <form action="<?php echo base_url() . 'checkout'; ?>" method="POST" class="form-container  shadow-container" style="width:80%">
                <h3 class="mt-3">Detail Belanja</h3>
                <hr>
