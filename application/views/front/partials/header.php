...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url() . ''; ?>"><i class="fas fa-utensil-spoon"></i> FoodCourt</a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url() . 'restaurant'; ?>">Toko</a>
                    </li>
                    ...
                    ?>
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo base_url() . 'singup' ?>">Register</a>
                        </li>
                    <?php } else { ?>
