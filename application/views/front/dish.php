<div class="container p-4">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Menu Toko <?php echo $res['name']; ?></h1>
        </div>
    </div>
    <div class="container res-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    Selamat datang! Anda dapat memesan makanan dan minuman sehat cepat saji karena dilengkapi dengan buah dan sayur yang segar di sini!
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url() . 'Dish/addToCart/' . $dish['d_id']; ?>" class="btn btn-primary"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
