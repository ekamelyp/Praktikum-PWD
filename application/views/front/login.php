...
<body>
    <div class="wrapper mt-sm-5">
        <h4 class="pb-4 border-bottom text-center">Login Page</h4>
        <?php
        ...
        <form action="<?php echo base_url() . 'login/authenticate'; ?>" name="loginform" id="loginform" method="POST">
            <div class="form-group">
                <input type="text" class="form-control bg-light my-4" name="username" id="username" placeholder="Username">
                <span></span>
            </div>
            ...
            <div class="text-center my-3">
                Belum punya account? KliK<a href="<?= base_url('singup'); ?>"> Register</a>
            </div>
        </form>
    </div>
    <script>
