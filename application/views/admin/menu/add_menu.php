<div class="conatiner">
    <form action="<?php echo base_url() . 'admin/menu/create_menu'; ?>" method="POST" id="myForm" name="myForm" class="form-container mx-auto  shadow-container" style="width:80%" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : ''; ?>" name="name" id="name" placeholder="Enter Dish name" value="<?php echo set_value('name'); ?>">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : ''; ?>" id="price" name="price" placeholder="Enter Price Rp." value="<?php echo set_value('price'); ?>">
        ...
        <a href="<?php echo base_url() . 'admin/menu' ?>" class="btn btn-secondary">Back</a>
    </form>
</div>
<script>
